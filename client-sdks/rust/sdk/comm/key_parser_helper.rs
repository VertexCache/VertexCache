...
pub fn config_public_key_if_enabled(pem: &str) -> Result<Vec<u8>, VertexCacheSdkException> {
    let cleaned = pem
...
pub fn config_shared_key_if_enabled(base64: &str) -> Result<Vec<u8>, VertexCacheSdkException> {
    let decoded = STANDARD
        .decode(base64)
