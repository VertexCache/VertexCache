 ...
 *
 * This class is used to guide how data is encrypted and decrypted throughout
 * the client's message layer.
 */
class EncryptionMode
{
    public const NONE = 'NONE';
    public const ASYMMETRIC = 'ASYMMETRIC';   // RSA public/private
    public const SYMMETRIC = 'SYMMETRIC';     // AES shared key
}
