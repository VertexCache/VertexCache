...
@Tag("manual")
public class CacheFIFOPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "FIFO";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.FIFO;
