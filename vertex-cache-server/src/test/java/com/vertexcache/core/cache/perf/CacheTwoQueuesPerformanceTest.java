...
@Tag("manual")
public class CacheTwoQueuesPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "TwoQueues";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.TwoQueues;
