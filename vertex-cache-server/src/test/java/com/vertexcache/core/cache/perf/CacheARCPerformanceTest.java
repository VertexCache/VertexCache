...
@Tag("manual")
public class CacheARCPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "ARC";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.ARC;
