...
@Tag("manual")
public class CacheLRUPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "LRU";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.LRU;
