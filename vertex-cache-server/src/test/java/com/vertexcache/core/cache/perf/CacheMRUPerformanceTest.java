...
@Tag("manual")
public class CacheMRUPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "MRU";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.MRU;
