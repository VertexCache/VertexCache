...
@Tag("manual")
public class CacheTinyLFUPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "TinyLFU";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.TinyLFU;
