...
@Tag("manual")
public class CacheClockPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "Clock";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.Clock;
