...
@Tag("manual")
public class CacheRandomPerformanceTest extends BasePerformanceTest {

    private final static String PREFIX_LABEL = "Random";
    private final static EvictionPolicy EVICTION_POLICY = EvictionPolicy.RANDOM;
