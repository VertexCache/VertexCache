 ...
 */
package com.vertexcache.module.metric.counter;
...
/**
 * Tracks the number of 'get', 'set', and 'del' commands executed by a client.
 * Uses LongAdder for efficient, thread-safe counting in concurrent environments.
 * Primarily used to collect per-client command metrics for internal monitoring.
 */
